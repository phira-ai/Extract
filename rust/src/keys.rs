...
pub const CYCLE_PREV: KeyCode = KeyCode::Left;
pub const CYCLE_NEXT: KeyCode = KeyCode::Right;
pub const NAV_LEFT_H: KeyCode = KeyCode::Char('h');
pub const NAV_RIGHT_L: KeyCode = KeyCode::Char('l');
pub const NAV_LEFT: KeyCode = KeyCode::Left;
pub const NAV_RIGHT: KeyCode = KeyCode::Right;
...
pub const MARK_COMPLETED: KeyCode = KeyCode::Char('C');
